<nav
    class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:shadow-md dark:shadow-white">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="/admin/dashboard" class="flex ml-2 md:mr-24">
                    <img src="{{ asset('images/logo/logo-southbuton.png') }}" class="h-[40px] mr-3"
                        alt="FlowBite Logo" />
                </a>
            </div>
