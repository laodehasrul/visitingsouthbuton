    ...
    <section>
        <div class="relative w-full h-auto">
            <div class="relative w-full bg-cover bg-center">
                <img class="w-full h-[400px] object-cover object-center" src="{{ asset('assets/event-festival.jpg') }}"
                    alt="">
                <div class="absolute z-10 w-full mx-auto bottom-0 pb-5 md:pb-10 mb-10 text-center">
                    <div class="flex flex-col items-center mx-auto text-center h-auto text-white">
                        ...
                        <div class="max-w-4xl pt-5 text-xl lg:text-2xl">
                            <h2>Informasi agenda event wisata yang ada di Buton Selatan</h2>
                        </div>
            ...
            <div class="relative w-full px-5 md:px-0 md:flex space-y-5 md:space-y-0 space-x-0 md:space-x-4">
                            ...
                            <div class="mt-2">
                                <div class="flex mx-auto relative max-w-full group">
                                    <div class="relative w-1/2 overflow-hidden mr-2 rounded-md shadow-md">
                                        <a href="{{ route('detail-event', $item->slug) }}">
                                            <img class="w-full min-h-full h-[140px] md:h-[180px] lg:h-[200px] object-cover transform hover:scale-110 duration-200"
                                            ...
                                            <div class="absolute w-full bottom-0 flex items-center justify-between">
                                                <div class="relative bottom-0 left-0 ml-[15px] mb-[10px]">
                                                    <span
                                                        class="px-3 py-2 bg-teal-500 text-white text-[10px] font-bold uppercase">Event</span>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="w-1/2">
                                        <a href="{{ route('detail-event', $item->slug) }}">
                                            <h1 class="uppercase font-semibold hover:text-teal-600">
                                                <p class="text-[12px] sm:text-sm lg:text-lg">
                                                    {{ $item->title }}
                                                </p>
                                            ...
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <div class="flex items-center space-x-2">
                                                    <div class="flex items-center">
                                                        ...
                                                        @livewire('event.eventvote', ['getevent' => $item], key($item->id))
                                                    </div>
                                                    <div class="flex items-center">
                ...
                <div class="relative w-full md:w-1/3">
                    <div class="relative min-h-[1px] h-full px-4">
                        <div class="sticky w-full top-0 bg-transparent">
                            <div class="relative">
