<div
    class="p-4 rounded-md mt-2 text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-800 dark:text-white dark:shadow-md dark:shadow-teal-400">
    <div class="flex justify-center mx-auto text-center items-center mb-4">
        @if ($isEditMode)
            <h1 class="uppercase font-bold text-lg ">Update Kategori</h1>
        @else
            <h1 class="uppercase font-bold text-lg">Tambah Kategori</h1>
        @endif
    </div>
    <form>
        <div class="relative z-0 w-full mb-6 group">
            <input wire:model="title" wire:keyup='generateSlug' type="text" name="title" id="title"
        ...
        <div class="relative z-0 w-full mb-6 group lg:flex items-start lg:space-x-5">
            ...
            <div class="w-full lg:w-1/3">
                ...
                <div>
                    @if ($isEditMode)
                        ...
                        @else
                            <label style="background-image: url('{{ asset('storage/category') }}/{{ $oldimage }}')"
