        ...
        <form>
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-6 group">
                    ...
                    @error('name') <span class="text-xs text-red-500 dark:text-white">{{ $message }}</span> @enderror
                </div>
                <div class="relative z-0 w-full mb-6 group">
            ...
            <div class="relative z-0 w-full mb-6 group">
                ...
                <select id="countries" wire:model="category" name="category"
                    ...
                    @include('livewire.admin.destinasi.kategori.child',['subcategories' =>
                    $category->childrens])
                    @endif
                    @endforeach
                    @endif
                </select>
                @error('category') <span class="text-xs text-red-500 dark:text-white">{{ $message }}</span> @enderror
            </div>
            <div id="address" class="relative w-full mb-5">
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        @error('address') <span class="text-xs text-red-500 dark:text-white">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="relative z-0 w-full mb-6 group">
                        <div class="relative z-0 w-full mb-6 group">
                            ...
                            @error('latitude') <span class="text-xs text-red-500 dark:text-white">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="relative z-0 w-full mb-6 group">
                            ...
                            @error('longitude') <span class="text-xs text-red-500 dark:text-white">{{ $message }}</span>
                            @enderror
                        </div>
                    </div>
                </div>
            ...
            <div class="w-full lg:flex items-start mb-5 lg:space-x-5">
                ...
                <div class="w-full lg:w-2/3">
                    ...
                    <div class="flex items-center justify-center w-full">
                        ...
                        <label
                            ...
                            <div class="relative object-cover flex flex-wrap gap-2 top-0 left-0">
                                @foreach($galery as $image_galery)
                                <div class="bg-white relative flex w-[100px] h-[100px] z-20">
                                    <img class="object-fill" src="{{ $image_galery->temporaryUrl() }}" alt="">
                                </div>
                                @endforeach
                            </div>
                    ...
                    <div class="cursor-pointer filepoond-galery">
                        <x-filepond wire:model="galery" multiple allowFileTypeValidation
                            acceptedFileTypes="['image/png', 'image/jpg', 'image/JPG', 'image/jpeg']"
                            allowFileSizeValidation maxFileSize="4mb" />
                        @error('galery.*') <span class="text-xs text-red-500 dark:text-white">{{ $message }}</span>
                        @enderror
                    </div>
                </div>
            </div>
