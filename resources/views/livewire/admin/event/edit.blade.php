...
<div class="mt-5 p-5 shadow-xl rounded-md dark:bg-gray-800 dark:shadow-md dark:shadow-white">
    ...
    <div
        ...
        <h1 class="uppercase font-semibold text-xl dark:text-white">Perbaharui Data Event</h1>
    </div>
    <div class="mt-5">
        <form>
            ...
            <div class="grid md:grid-cols-3 md:gap-6 mb-5">
                ...
                <div class="w-full col-span-3 md:col-span-1">
                    <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Image
                        ...
                        @else
                        <label style="background-image: url('{{ asset('storage/event-festival') }}/{{ $oldimage }}')"
            ...
            <div class="relative max-w-sm mb-5">
                <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal Event</label>
                <div class="flex flex-col space-y-10">
                    <div>
                        <input wire:model.lazy="date" type="text"
                            ...
                            @error('date') <span class="text-xs text-red-500 dark:text-white">{{ $message }}</span> @enderror
                    </div>
                </div>
            </div>
            <div>
