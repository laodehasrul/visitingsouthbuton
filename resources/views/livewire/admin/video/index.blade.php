@section('title', "Admin Video Galery")
<div
    ...
    <div class="container flex flex-col items-center justify-center px-4 pt-2 pb-8 mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex ">
                    <div class="w-1/2 mx-auto text-gray-500">
                        <section class="flex items-center justify-center">
                            <div class="flex items-center justify-center w-1/2" role="search" aria-label="Sitewide">
        ...
        <div wire:loading.class="invisible" wire:target="search"
            class="grid max-w-full gap-5 mx-auto mt-5 md:grid-cols-2 lg:grid-cols-3 md:max-w-none">
            @forelse ($videos as $item)
                <div
                    ...
                    <div class="relative flex-shrink-0">
                        <x-embed class="w-full h-56" url="{{ $item->url_video }}" aspect-ratio="16:9" />
                        @if ($item->viewer > 0)
                        <span
                        class="absolute bottom-0 right-0 inline-flex items-center px-3 py-1 mr-4 -mb-3 text-xs font-medium leading-tight text-gray-800 bg-gray-100 border rounded-full">{{ $item->viewer }}
                        Watch</span>
                        @else
                        <span
                        class="absolute bottom-0 right-0 inline-flex items-center px-3 py-1 mr-4 -mb-3 text-xs font-medium leading-tight text-gray-800 bg-gray-100 border rounded-full">0
                        Watch</span>
                        @endif
                    ...
                    <div class="flex flex-col justify-between flex-1">
                        <div class="flex flex-col justify-between flex-1 p-4 bg-white">
                            <div>
                                <a href="#"
                                    class="block text-md font-semibold leading-none text-gray-900">{{ $item->title }}</a>
                        ...
                        <div class="flex items-center p-3 bg-gray-100">
                            ...
                            <div class="ml-3 flex w-full justify-between">
                                <div class="flex items-center">
                                    <label for="date" class="text-xs leading-5 text-gray-600 mr-1">Tanggal :</label>
                                ...
                                <div class="text-end">
                                    ...
                                    <a href="{{ route('video.edit', $item->id) }}" data-tooltip-target="tooltip-edit"
