@section('title', "Admin Kanban Management")
<div class="mt-2">
    <!-- tables start -->
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-2 dark:shadow-md dark:shadow-white">
        <div
            ...
            @if ($isModalOpen)
                @include('livewire.admin.kanban.create')
            @endif
        </div>
            ...
            <tbody class="">
                @forelse ($data as $item)
                    <tr
                        ...
                        <td scope="row"
                            class="capitalize px-6 py-4 font-medium text-gray-900 dark:text-white w-auto">
                            {{ $loop->index+1 }}
                        </td>
                        <td scope="row"
                            class="capitalize px-6 py-4 font-medium text-gray-900 dark:text-white w-auto">
                        ...
                        <td class="px-6 py-4">
                            <a class="truncate" target="#" href="{{ $item->url }}">
                                <img class="w-[200px] h-[100px] object-cover object-center rounded-md hover:shadow-xl dark:shadow-md dark:hover:shadow-white transform-all duration-300 hover:scale-125 hover:-translate-y-2"
                                    src="{{ asset('storage/kanban') }}/{{ $item->image }}" alt="">
                            </a>
                        </td>
                        <td
        ...
        <div class="justify-center items-center mx-auto">{{ $data->links() }}</div>
    </div>
