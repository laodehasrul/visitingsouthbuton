...
<div class="mt-5 p-5 shadow-xl rounded-md dark:bg-gray-800 dark:shadow-md dark:shadow-white">
    <div
        ...
        <h1 class="uppercase font-semibold text-xl dark:text-white">Tambah Page</h1>
    </div>
    <div class="mt-5">
        <form>
            ...
            <div class="mb-5">
                <div class="relative w-full mb-2 col-span-3 md:col-span-2">
                    <label for="message"
            ...
            <div>
                <label class="col-sm-2 control-label dark:text-white font-semibold mb-2 pb-2" for=" ">Body </label>
                <div class="col-sm-10">
                    <div class=" border border-gray-600 ">
                        <x-ckeditor id="body" name="body" wire:model="body"/>
                    </div>
                </div>
            </div>
            <div>
                @error('body') <span class="text-xs text-red-500 dark:text-white">{{ $message }}</span> @enderror
            </div>
