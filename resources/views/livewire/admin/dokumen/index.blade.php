...
<div class="mt-2">
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg dark:shadow-white">
        <div class="flex items-center justify-between p-5 dark:bg-gray-800">
        ...
        @if ($isModalOpen)
            @include('livewire.admin.dokumen.createorupdate')
        @endif
            ...
            <tbody wire:loading.class="invisible" wire:target="search">
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <button wire:click="download({{$item->id}})">
                                <div class="rounded-full bg-gray-200 p-1 hover:bg-teal-500 hover:text-white tranform hover:animate-bounce ease-in">
                ...
                @empty
                    <tr
                        ...
                        <th class="row pl-3">
                            <div class="flex items-center me-4">
                                <input id="" type="checkbox" value="" disabled
                                    class="w-4 h-4 text-green-600 bg-gray-100 border-gray-300 rounded focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for=""
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"></label>
                            </div>
