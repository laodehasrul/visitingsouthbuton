...
<div
    class="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto text-gray-900 bg-gray-100 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32">
    ...
    <div>
        <form wire:submit="send">
            <div>
                <span class="text-sm font-bold text-gray-600 uppercase">Nama Lengkap</span>
                <input name="fullname" wire:model="fullname"
                    class="w-full p-3 mt-2 text-gray-900 bg-gray-300 rounded-lg focus:outline-none focus:shadow-outline"
                    type="text" placeholder="">
            </div>
            @error('fullname')
                <div class="flex items-center p-2 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
                    role="alert">
            ...
            @enderror
            <div class="mt-4">
                <span class="text-sm font-bold text-gray-600 uppercase">Subjek</span>
                <input name="subject" wire:model="subject"
                    class="w-full p-3 mt-2 text-gray-900 bg-gray-300 rounded-lg focus:outline-none focus:shadow-outline"
                    type="text">
            </div>
            @error('subject')
            ...
            @enderror
            <div class="mt-4">
                <span class="text-sm font-bold text-gray-600 uppercase">Pesan</span>
                <textarea name="message" wire:model="message"
            ...
            <div class="mt-4">
                <button
                    ...
                    <svg wire:loading wire:target="send" aria-hidden="true"
                    ...
                    <span wire:loading.attr="disabled" wire:loading.remove wire:target="send">Kirim Pesan</span>
                </button>
            </div>
        </form>
